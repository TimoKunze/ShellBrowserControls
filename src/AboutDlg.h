...
///
/// \sa ICreditsProvider, ShellListView, ShellTreeView
//////////////////////////////////////////////////////////////////////
...
protected:
	...
	struct Controls
	{
		...
		/// \brief <em>Wraps the static label displaying the thanks to Henk Devos</em>
		CStatic specialThanks_Henk;
		/// \brief <em>Wraps the static label displaying the thanks to Jim Kueneman</em>
		CStatic specialThanks_Jim;
		/// \brief <em>Wraps the link label displaying the URL of Nikos Bozinis' website</em>
		HyperLinkEx specialThanks_Nikos;
