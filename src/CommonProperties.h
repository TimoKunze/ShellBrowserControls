...
#endif
#include "ctlinterfaces/exlvw/ShellListView.h"
#include "ctlinterfaces/extvw/ShellTreeView.h"
...
protected:
	...
	struct Controls
	{
		...
		/// \brief <em>Wraps the listview displaying the values for the \c InfoTipFlags property</em>
		CCheckListViewCtrl infoTipFlagsList;
		/// \brief <em>Wraps the listview displaying the values for the \c UseSystemImageList property</em>
		CCheckListViewCtrl useSystemImageListList;
