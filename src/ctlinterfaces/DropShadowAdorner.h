//////////////////////////////////////////////////////////////////////
/// \class DropShadowAdorner
/// \author Timo "TimoSoft" Kunze
/// \brief <em>Implements \c IThumbnailAdorner and draws drop shadows around thumbnail images</em>
///
/// This thumbnail image adorner is used to draw drop shadows around thumbnail images. It is used for
/// thumbnails of files, except for image and video files.
///
/// \sa IThumbnailAdorner, PhotoBorderAdorner, SprocketAdorner, ShLvwThumbnailTask
//////////////////////////////////////////////////////////////////////
...
// {9B9F6A2C-7D7C-4AC2-87EC-8A7A676812D9}
DEFINE_GUID(CLSID_DropShadowAdorner, 0x9B9F6A2C, 0x7D7C, 0x4AC2, 0x87, 0xEC, 0x8A, 0x7A, 0x67, 0x68, 0x12, 0xD9);


class DropShadowAdorner :
    public CComObjectRootEx<CComMultiThreadModel>,
    public CComCoClass<DropShadowAdorner, &CLSID_DropShadowAdorner>,
...
public:
		...
		BEGIN_COM_MAP(DropShadowAdorner)
