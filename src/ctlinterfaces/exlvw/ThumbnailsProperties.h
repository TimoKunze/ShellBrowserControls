//////////////////////////////////////////////////////////////////////
/// \class ThumbnailsProperties
/// \author Timo "TimoSoft" Kunze
/// \brief <em>The controls' "Thumbnails" property page</em>
///
/// This class contains the controls' "Thumbnails" property page.
///
/// \sa ShellListView
//////////////////////////////////////////////////////////////////////
...
class ATL_NO_VTABLE ThumbnailsProperties :
    public CComObjectRootEx<CComSingleThreadModel>,
    public CComCoClass<ThumbnailsProperties, &CLSID_ThumbnailsProperties>,
    public IPropertyPage2Impl<ThumbnailsProperties>,
    public CDialogImpl<ThumbnailsProperties>
{
public:
	...
	ThumbnailsProperties();
		...
		enum { IDD = IDD_THUMBNAILSPROPERTIES };

		DECLARE_REGISTRY_RESOURCEID(IDR_THUMBNAILSPROPERTIES)

		BEGIN_COM_MAP(ThumbnailsProperties)
			COM_INTERFACE_ENTRY(IPropertyPage)
		END_COM_MAP()

		BEGIN_MSG_MAP(ThumbnailsProperties)
...
protected:
	...
	/// \param[in] checkForEquality If set to \c TRUE, this method does not check for the specified bits
	///            being set, but for equality of the array elements with the specified bits.
	///
	...
	///
	/// \sa SetBit
	static int CalculateStateImageMask(UINT arraysize, LONG* pArray, LONG bitsToCheckFor, BOOL checkForEquality = FALSE);
	...
	struct Controls
	{
		/// \brief <em>Wraps the listview displaying the values for the \c DisplayThumbnailAdornments property</em>
		CCheckListViewCtrl displayThumbnailAdornmentsList;
...
OBJECT_ENTRY_AUTO(CLSID_ThumbnailsProperties, ThumbnailsProperties)