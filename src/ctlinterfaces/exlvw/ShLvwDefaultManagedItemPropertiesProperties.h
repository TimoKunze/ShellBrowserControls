//////////////////////////////////////////////////////////////////////
/// \class ShLvwDefaultManagedItemPropertiesProperties
/// \author Timo "TimoSoft" Kunze
/// \brief <em>The \c ShellListView control's "Default Managed Properties" property page</em>
///
/// This class contains the \c ShellListView control's "Default Namespace Enum Settings" property page.
///
/// \sa ShellListView
//////////////////////////////////////////////////////////////////////
...
class ATL_NO_VTABLE ShLvwDefaultManagedItemPropertiesProperties :
    public CComObjectRootEx<CComSingleThreadModel>,
    public CComCoClass<ShLvwDefaultManagedItemPropertiesProperties, &CLSID_ShLvwDefaultManagedItemPropertiesProperties>,
    public IPropertyPageImpl<ShLvwDefaultManagedItemPropertiesProperties>,
    public CDialogImpl<ShLvwDefaultManagedItemPropertiesProperties>
{
public:
	/// \brief <em>The constructor of this class</em>
	///
	/// Used for initialization.
	ShLvwDefaultManagedItemPropertiesProperties();

	#ifndef DOXYGEN_SHOULD_SKIP_THIS
		enum { IDD = IDD_DEFAULTMANAGEDITEMPROPERTIESPROPERTIES };

		DECLARE_REGISTRY_RESOURCEID(IDR_SHLVWDEFAULTMANAGEDITEMPROPERTIESPROPERTIES)

		BEGIN_COM_MAP(ShLvwDefaultManagedItemPropertiesProperties)
			COM_INTERFACE_ENTRY(IPropertyPage)
		END_COM_MAP()

		BEGIN_MSG_MAP(ShLvwDefaultManagedItemPropertiesProperties)
...
OBJECT_ENTRY_AUTO(CLSID_ShLvwDefaultManagedItemPropertiesProperties, ShLvwDefaultManagedItemPropertiesProperties)