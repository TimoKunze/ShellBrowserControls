...
#include "RunTimeHelperEx.h"

#ifndef DOXYGEN_SHOULD_SKIP_THIS
	extern CTraceCategory shlvwTraceAutoUpdate;
	extern CTraceCategory shlvwTraceContextMenus;
	extern CTraceCategory shlvwTraceDragDrop;
	extern CTraceCategory shlvwTraceCtlCommunication;
	extern CTraceCategory shlvwTraceThreading;

	extern CTraceCategory shtvwTraceAutoUpdate;
	extern CTraceCategory shtvwTraceContextMenus;
	extern CTraceCategory shtvwTraceDragDrop;
	extern CTraceCategory shtvwTraceCtlCommunication;
	extern CTraceCategory shtvwTraceThreading;
#endif