// ShBrowserCtls.cpp: Implementation of DLL exports.
...
class ShBrowserCtlsModule :
    public CAtlDllModuleT<ShBrowserCtlsModule>
{

public:
  #ifdef UNICODE
		DECLARE_LIBID(LIBID_ShBrowserCtlsLibU)
		DECLARE_REGISTRY_APPID_RESOURCEID(IDR_SHBROWSERCTLS, "{4E2EAABE-6D4E-4a7f-8DF2-99E2000F5AAC}")
	#else
		DECLARE_LIBID(LIBID_ShBrowserCtlsLibA)
		DECLARE_REGISTRY_APPID_RESOURCEID(IDR_SHBROWSERCTLS, "{3251B743-9E9C-411d-8937-E62DE0B0C3E9}")
	#endif
};

ShBrowserCtlsModule _AtlModule;
